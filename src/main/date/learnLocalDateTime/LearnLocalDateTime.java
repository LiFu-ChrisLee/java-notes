...
/**
 * @author LiFu
 * @date 2020/5/12 下午5:12
 * @description learn LocalDateTime
 */
...
//        注意ISO 8601规定的日期和时间分隔符是T。标准格式如下：
        ...
        System.out.println(du); // PT1235H10M30S，表示1235小时10分钟30秒
        ...
        // 利用ofXxx()或者parse()方法可以直接创建Duration
        Duration du1 = Duration.ofHours(10); // 10 hours
        Duration du2 = Duration.parse("P1DT2H3M"); // 1 day, 2 hours, 3 minutes
